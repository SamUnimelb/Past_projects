...
class Evaluator:
    ...
    def predictTwittData(self):
        ...
        for eachLine in f:
            ...
            predictResult.write(id + "\t" + sentence + "\t" + str(weight) + "\t"
    ...
    def weightForSentence(self, sentence):
        ...
        tokens = substractBinTerms(terms)

        weight = 0.0

        for eachTerm in tokens:
    ...
    def evaluateModel(self):
        print "Total twits, true positives, false negatives, false positives and true negatives: "
