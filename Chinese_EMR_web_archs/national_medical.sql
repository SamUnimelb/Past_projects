CREATE DATABASE  IF NOT EXISTS `national_medical` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `national_medical`;
...
CREATE TABLE `cities` (
  ...
  CONSTRAINT `provID` FOREIGN KEY (`provID`) REFERENCES `province` (`provID`)
...
CREATE TABLE `citizen` (
  ...
  `agree_share` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `diagonse` (
  ...
  CONSTRAINT `doctor_user` FOREIGN KEY (`doctor_user`) REFERENCES `doctor` (`username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-07-26 11:11:46
